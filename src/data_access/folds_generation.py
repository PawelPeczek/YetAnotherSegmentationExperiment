...
class FoldsGenerator:
    ...
    def __init__(self,
        ...
        self.__random_split_generator.set_background_wildcard(
            generator_specs.allowed_background_wildcard
        )
        self.__rotation_based_split_generator = RotationBasedSplitGenerator(
            dataset_path=dataset_path,
            splits_specs=generator_specs.rotation_based_splits
        )
        self.__rotation_based_split_generator.set_background_wildcard(
            generator_specs.allowed_background_wildcard
        )
